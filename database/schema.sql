...
CREATE TABLE IF NOT EXISTS `kas_categories` (
  ...
  COMMENT='Kategori transaksi kas RW/RT';
...
CREATE TABLE IF NOT EXISTS `kas_transactions` (
  ...
  COMMENT='Semua transaksi kas RW dan RT';
...
CREATE TABLE IF NOT EXISTS `kas_balance` (
  ...
  COMMENT='Saldo mutakhir kas RW/RT';

-- ── 28. KAS_BALANCE_HISTORY ──────────────────────────────────
CREATE TABLE IF NOT EXISTS `kas_balance_history` (
  ...
  COMMENT='Riwayat saldo kas setiap perubahan transaksi';
